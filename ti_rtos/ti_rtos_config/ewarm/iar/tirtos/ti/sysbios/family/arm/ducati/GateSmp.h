...
#define ti_sysbios_family_arm_ducati_GateSmp___VERS 160
...
__extern xdc_Void ti_sysbios_family_arm_ducati_GateSmp_Instance_init__E(ti_sysbios_family_arm_ducati_GateSmp_Object *, const ti_sysbios_family_arm_ducati_GateSmp_Params *);

/* Instance_init__R */
xdc__CODESECT(ti_sysbios_family_arm_ducati_GateSmp_Instance_init__R, "ti_sysbios_family_arm_ducati_GateSmp_Instance_init")
__extern xdc_Void ti_sysbios_family_arm_ducati_GateSmp_Instance_init__R(ti_sysbios_family_arm_ducati_GateSmp_Object *, const ti_sysbios_family_arm_ducati_GateSmp_Params *);
...
/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_family_arm_ducati_GateSmp_Object__destruct__S, "ti_sysbios_family_arm_ducati_GateSmp_Object__destruct__S")
