...
#define ti_sysbios_gates_GateSwi___VERS 160
...
__extern xdc_Void ti_sysbios_gates_GateSwi_Instance_init__E(ti_sysbios_gates_GateSwi_Object *, const ti_sysbios_gates_GateSwi_Params *);

/* Instance_init__R */
xdc__CODESECT(ti_sysbios_gates_GateSwi_Instance_init__R, "ti_sysbios_gates_GateSwi_Instance_init")
__extern xdc_Void ti_sysbios_gates_GateSwi_Instance_init__R(ti_sysbios_gates_GateSwi_Object *, const ti_sysbios_gates_GateSwi_Params *);
...
/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_gates_GateSwi_Object__destruct__S, "ti_sysbios_gates_GateSwi_Object__destruct__S")
