...
__extern xdc_Int ti_sysbios_hal_TimerNull_Instance_init__R(ti_sysbios_hal_TimerNull_Object *, xdc_Int id, ti_sysbios_interfaces_ITimer_FuncPtr tickFxn, const ti_sysbios_hal_TimerNull_Params *, xdc_runtime_Error_Block *);

/* Instance_finalize__R */
xdc__CODESECT(ti_sysbios_hal_TimerNull_Instance_finalize__R, "ti_sysbios_hal_TimerNull_Instance_finalize")
__extern void ti_sysbios_hal_TimerNull_Instance_finalize__R( ti_sysbios_hal_TimerNull_Object* , int );
...
__extern xdc_UInt32 ti_sysbios_hal_TimerNull_getMaxTicks__F( ti_sysbios_hal_TimerNull_Object *__inst );
__extern xdc_UInt32 ti_sysbios_hal_TimerNull_getMaxTicks__R( ti_sysbios_hal_TimerNull_Handle __inst );
...
__extern xdc_Void ti_sysbios_hal_TimerNull_setNextTick__F( ti_sysbios_hal_TimerNull_Object *__inst, xdc_UInt32 ticks );
__extern xdc_Void ti_sysbios_hal_TimerNull_setNextTick__R( ti_sysbios_hal_TimerNull_Handle __inst, xdc_UInt32 ticks );
...
xdc__CODESECT(ti_sysbios_hal_TimerNull_getExpiredTicks__F, "ti_sysbios_hal_TimerNull_getExpiredTicks")
__extern xdc_UInt32 ti_sysbios_hal_TimerNull_getExpiredTicks__F( ti_sysbios_hal_TimerNull_Object *__inst, xdc_UInt32 tickPeriod );
__extern xdc_UInt32 ti_sysbios_hal_TimerNull_getExpiredTicks__R( ti_sysbios_hal_TimerNull_Handle __inst, xdc_UInt32 tickPeriod );
...
xdc__CODESECT(ti_sysbios_hal_TimerNull_getCurrentTick__F, "ti_sysbios_hal_TimerNull_getCurrentTick")
__extern xdc_UInt32 ti_sysbios_hal_TimerNull_getCurrentTick__F( ti_sysbios_hal_TimerNull_Object *__inst, xdc_Bool save );
__extern xdc_UInt32 ti_sysbios_hal_TimerNull_getCurrentTick__R( ti_sysbios_hal_TimerNull_Handle __inst, xdc_Bool save );
