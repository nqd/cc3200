...
#define ti_sysbios_hal_Timer_TimerProxy___VERS 160
...
struct ti_sysbios_hal_Timer_TimerProxy_Fxns__ {
    ...
    xdc_UInt32 (*getMaxTicks)(ti_sysbios_hal_Timer_TimerProxy_Handle);
    xdc_Void (*setNextTick)(ti_sysbios_hal_Timer_TimerProxy_Handle, xdc_UInt32);
    ...
    xdc_UInt32 (*getExpiredTicks)(ti_sysbios_hal_Timer_TimerProxy_Handle, xdc_UInt32);
    xdc_UInt32 (*getCurrentTick)(ti_sysbios_hal_Timer_TimerProxy_Handle, xdc_Bool);
...
/* Object__create__S */
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_Object__create__S, "ti_sysbios_hal_Timer_TimerProxy_Object__create__S")
...
/* Object__delete__S */
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_Object__delete__S, "ti_sysbios_hal_Timer_TimerProxy_Object__delete__S")
...
/* Object__destruct__S */
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_Object__destruct__S, "ti_sysbios_hal_Timer_TimerProxy_Object__destruct__S")
...
__extern xdc_UInt32 ti_sysbios_hal_Timer_TimerProxy_getMaxTicks__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst );
...
__extern xdc_Void ti_sysbios_hal_Timer_TimerProxy_setNextTick__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst, xdc_UInt32 ticks );
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_getExpiredTicks__R, "ti_sysbios_hal_Timer_TimerProxy_getExpiredTicks")
__extern xdc_UInt32 ti_sysbios_hal_Timer_TimerProxy_getExpiredTicks__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst, xdc_UInt32 tickPeriod );
...
xdc__CODESECT(ti_sysbios_hal_Timer_TimerProxy_getCurrentTick__R, "ti_sysbios_hal_Timer_TimerProxy_getCurrentTick")
__extern xdc_UInt32 ti_sysbios_hal_Timer_TimerProxy_getCurrentTick__R( ti_sysbios_hal_Timer_TimerProxy_Handle __inst, xdc_Bool save );
